...
if keyboard_check_pressed(ord(CurrencyCounter_OBJ.PauseBind)) and onetime == false{
	paused = true
	onetime = true
}
if keyboard_check_pressed(ord(CurrencyCounter_OBJ.PauseBind)) and onetime == true{
	paused = !paused
}
